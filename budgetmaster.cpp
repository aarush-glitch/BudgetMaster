...
public:
    ...
    void recommendExpenseCuts()
    {
        ...
        else if (foodPercent >= accomPercent && foodPercent >= transPercent && foodPercent >= miscPercent)
        {
        ...
        else if (transPercent >= accomPercent && transPercent >= foodPercent && transPercent >= miscPercent)
        {
        ...
        else if (miscPercent >= accomPercent && miscPercent >= transPercent && miscPercent >= foodPercent)
        {
